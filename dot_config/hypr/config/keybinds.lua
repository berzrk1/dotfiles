...
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(launchPrefix .. FILE_MANAGER_TERM))
...
hl.bind(mainMod .. " + ALT + SHIFT + CTRL + code:49", hl.dsp.exec_cmd("hyprctl switchxkblayout current next"))
...
---- NOTIFICATIONS ----
-----------------------
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd(noctCall .. "notifications toggleHistory"))
